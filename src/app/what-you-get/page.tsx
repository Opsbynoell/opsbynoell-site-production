...
const pricingCards: PricingCard[] = [
  {
    name: "Noell Agents",
    body: "Three AI agents working alongside the booking tool you already use. $397/mo founding rate, locked for your first 12 months.",
...
export default function WhatYouGetPage() {
  return (
    <div id="main-content">
      ...
      {/* HERO */}
      <section className="relative flex max-w-7xl rounded-b-3xl my-2 md:my-8 mx-auto flex-col items-center justify-center pt-24 md:pt-28 pb-12 md:pb-16 overflow-hidden px-4 md:px-8 bg-gradient-to-t from-[rgba(107,45,62,0.25)] via-[rgba(31,18,25,0.85)] to-[rgba(19,11,15,1)]">
