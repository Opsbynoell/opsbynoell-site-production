  ...
  return (
    <div>
      <JsonLd
        ...
        id="resources"
      />
      <section className="relative flex max-w-7xl rounded-b-3xl my-2 md:my-10 mx-auto flex-col items-center justify-center pt-28 md:pt-32 pb-12 md:pb-16 overflow-hidden px-4 md:px-8 bg-gradient-to-t from-[rgba(107,45,62,0.20)] via-[rgba(31,18,25,0.85)] to-[rgba(19,11,15,1)]">
