"use client";
/**
 * /upgrade — Landing page for businesses that have outgrown basic AI front desk tools.
 * Targets: Rosie AI, Goodcall, My AI Front Desk users who hit the ceiling.
 * Uses native opsbynoell.com components: Hero, FAQ, CTA, ProofBar.
...
const COMPETITORS = [
  { name: "Rosie AI", price: "$50–$150/mo", setup: "DIY", integration: "Basic webhook", voice: "Good", support: "Self-serve", managed: false },
  { name: "Goodcall", price: "$49–$99/mo", setup: "DIY", integration: "Limited", voice: "Robotic lag", support: "Self-serve", managed: false },
  { name: "My AI Front Desk", price: "$65–$97/mo", setup: "DIY", integration: "Zapier required", voice: "Good", support: "Email only", managed: false },
  { name: "Smith.ai", price: "$285–$750/mo", setup: "Assisted", integration: "Good", voice: "Human + AI", support: "Live agents", managed: false },
];

const NOELL = { name: "Ops by Noell", price: "$397–$897/mo", setup: "Done for you", integration: "Native CRM", voice: "Human-quality AI", support: "Managed team", managed: true };
...
const PAIN_POINTS = [
  {
    ...
    desc: "My AI Front Desk's #1 complaint. You were sold native CRM integration. What you got was a Zapier template and a support ticket. Ops by Noell connects directly — no middleware, no DIY.",
