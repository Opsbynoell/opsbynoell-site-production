...
export function LegalShell({
  ...
  return (
    <div>
      <section className="relative flex max-w-7xl rounded-b-3xl my-2 md:my-20 mx-auto flex-col items-center justify-center pt-32 pb-16 overflow-hidden px-4 md:px-8 bg-gradient-to-t from-[rgba(107,45,62,0.25)] via-[rgba(31,18,25,0.85)] to-[rgba(19,11,15,1)]">
        <p className="relative z-20 text-[11px] uppercase tracking-[0.25em] text-cream/70 mb-6">
          Legal · Last updated {legalUpdatedDate}
        </p>
        <h1 className="relative z-20 max-w-4xl text-center font-serif text-4xl md:text-6xl font-semibold tracking-tight text-cream">
          {title}
        </h1>
      ...
      <section className="pb-20 px-4">
        <article className="max-w-3xl mx-auto rounded-[22px] border border-white/10 bg-[#271520] p-8 md:p-12 shadow-[0px_34px_21px_0px_rgba(28,25,23,0.04),0px_15px_15px_0px_rgba(28,25,23,0.06),0px_4px_8px_0px_rgba(28,25,23,0.05)] prose prose-sm md:prose-base prose-headings:font-serif prose-headings:text-cream prose-p:text-cream/70 prose-li:text-cream/70 prose-a:text-wine prose-strong:text-cream">
          {children}
