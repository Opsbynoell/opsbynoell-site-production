  ...
  return (
    <section className="w-full px-4 pt-4 md:pt-8">
      <div className="max-w-6xl mx-auto">
        <div className="relative rounded-[28px] border border-wine/20 bg-[#1F1219] p-6 md:p-10 shadow-[0px_34px_21px_0px_rgba(28,25,23,0.04),0px_15px_15px_0px_rgba(28,25,23,0.06),0px_4px_8px_0px_rgba(28,25,23,0.05)] overflow-hidden">
          ...
          <div className="md:absolute md:top-6 md:right-6 mb-4 md:mb-0">
            <span className="inline-flex items-center rounded-full bg-wine text-cream px-3.5 py-1.5 text-[11px] font-medium tracking-wide">
              $397/mo. Rate locked from day one.
            </span>
          </div>
          ...
          <p className="mt-2 text-sm text-cream/75 leading-relaxed max-w-2xl">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-[auto_1fr] gap-6 md:gap-10 items-start">
            ...
            <div>
              <p className="text-[11px] uppercase tracking-[0.2em] text-cream/70 font-medium mb-4">
                What&apos;s included
              </p>
                ...
                <ul className="space-y-3">
                  {LEFT_ITEMS.map((item) => (
                    <li key={item} className="flex items-start gap-2.5">
                      ...
                      <span className="text-sm text-cream/85 leading-snug">
                        {item}
                      </span>
                    </li>
                  ))}
