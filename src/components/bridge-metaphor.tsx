    ...
    <section className="w-full px-4 my-14 md:my-20">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-sm md:text-base text-cream/70 max-w-2xl mx-auto leading-relaxed">
          ...
          <div>
            {rows.map((row, i) => (
              <div
                ...
                className={
                  "grid grid-cols-2 " +
                  (i !== rows.length - 1 ? "border-b border-white/10/70" : "")
                }
              >
                <div className="px-5 py-3.5 md:px-8 md:py-4 border-r border-white/10/70">
                  <p className="font-mono text-xs md:text-sm text-cream/70">
                    {row.then}
                  </p>
                </div>
                <div className="px-5 py-3.5 md:px-8 md:py-4 flex items-center gap-3">
                  ...
                  <p className="font-mono text-xs md:text-sm text-cream">
                    {row.now}
                  </p>
                </div>
              </div>
        ...
        <p className="text-center text-xs text-cream/70 mt-6 max-w-xl mx-auto">
