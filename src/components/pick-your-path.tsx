...
const cards: CardProps[] = [
  {
    ...
    banner: "Founding rate: $397/mo, locked 12 months",
    priceLine: "$397/mo founding rate ($497/mo after 12 months)",
  ...
  },
  {
    ...
    priceLine: "From $397/mo to $1,197/mo",
...
function Card({ card }: { card: CardProps }) {
  return (
    <div
      className={cn(
        "relative flex flex-col rounded-[22px] bg-[#271520] p-7 md:p-8 h-full",
        ...
        <Link
          ...
          className={cn(
            ...
            card.highlighted
              ...
              : "bg-[#271520] border border-white/10 text-cream hover:bg-[#1F1219]"
          )}
        >
          {card.ctaLabel}
        </Link>
