...
export const SERVICE_TIERS: PricingTier[] = [
  {
    ...
    summary: "All three agents. Nothing gets missed.",
    tagline:
      "Noell Support, Noell Front Desk, and Noell Care, working alongside the booking tool you already use. Live in 14 days.",
    features: [
      "Noell Support: 24/7 AI chat agent on your website, captures and scores leads",
      "Noell Front Desk: answers calls, schedules, confirms, and sends reminders",
      "Noell Care: handles returning clients, rebooks and service questions",
  ...
  },
  {
    ...
    summary: "Deeply integrated. Fully managed. Nothing falls through.",
    tagline:
      "The agents wired directly into your booking system, plus the recovery and reactivation campaigns that win back the clients you already have.",
    features: [
      "Everything in Signal",
      "Deep two-way PMS or booking integration (reads availability, writes confirmed bookings back)",
      "Reactivation campaigns: Noell Care wins back lapsed clients via SMS and email",
      "No-show recovery: automatic rebooking texts within minutes of a miss",
      "Google review automation after every appointment",
